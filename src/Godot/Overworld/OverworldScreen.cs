...
public partial class OverworldScreen : Control
{
    ...
    private OverworldMapView _mapView = null!;
    ...
    public event Action<OverworldPointOfInterest>? EnterSiteRequested;

    public void Configure(OverworldTravelState travelState, WorldTime time)
    {
    ...
    public override void _Ready()
    {
        ...
        _travelState ??= new OverworldTravelState(
        ...
        ApplyStateToControls();
        UpdateOverlay();
        _messageLog.AddMessage("Overworld travel started.");
    }
    ...
    {
        _mapView = new OverworldMapView
        {
            Name = "OverworldMapView"
        };
        ...
        stack.AddChild(CreateSectionTitle("Overworld"));
    ...
    private void ApplyStateToControls()
    {
        ...
        _mapView.Configure(_travelState, PrototypeOverworldSites.All);
        UpdateOverlay();
    }

    private void OnDestinationSelected(OverworldPosition destination)
    {
        if (_travelState is null)
        {
            return;
    ...
    private void OnEnterSitePressed()
    {
        ...
        var nearbySite = _travelState.FindNearbySite(PrototypeOverworldSites.All);
        if (nearbySite is null)
        {
            return;
        }

        _travelState.ClearDestination();
