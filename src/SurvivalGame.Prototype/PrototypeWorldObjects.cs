...
public static class PrototypeWorldObjects
{
    public static readonly WorldObjectId Wall = new("wall");
    public static readonly WorldObjectId Tree = new("tree");
    public static readonly WorldObjectId Fridge = new("fridge");
    public static readonly WorldObjectId WoodenDoor = new("wooden_door");
